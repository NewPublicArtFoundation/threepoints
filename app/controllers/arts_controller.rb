class ArtsController < InheritedResources::Base
  before_action :set_art, only: [:show, :edit, :update, :destroy, :vote]
  ...
  private
    ...
    def art_params
      params.require(:art).permit(:description, :location_id, :artist_id, :slug, :name, :created_at, :updated_at)
    end
end
