...
RSpec.describe "instagram_arts/edit", :type => :view do
  before(:each) do
  ...
  it "renders the edit instagram_art form" do
    render

    assert_select "form[action=?][method=?]", instagram_art_path(@instagram_art), "post" do
